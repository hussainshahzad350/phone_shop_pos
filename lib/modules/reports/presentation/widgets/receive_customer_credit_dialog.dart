...
class ReceiveCustomerCreditDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ReceiveCustomerCreditDialog> createState() =>
      _ReceiveCustomerCreditDialogState();
}

class _ReceiveCustomerCreditDialogState
    extends ConsumerState<ReceiveCustomerCreditDialog> {
  ...
  Future<void> _submit() async {
    ...
    if (max != null && max > 0 && amount > max + 0.009) {
      AppNotifier.error(UserFacingErrors.customerOverpayment(maxReceivable: max));
      return;
    }
